 ...
 * @namespace
 */
namespace YandexOld\DataSync;

use YandexOld\Common\AbstractServiceClient;
use GuzzleHttp\Psr7\Response;
use GuzzleHttp\Exception\ClientException;
use YandexOld\Common\Exception\ForbiddenException;
use YandexOld\Common\Exception\IncorrectDataFormatException;
use YandexOld\DataSync\Exception\IncorrectRevisionNumberException;
use YandexOld\Common\Exception\InvalidArgumentException;
use YandexOld\DataSync\Exception\MaxDatabasesCountException;
use YandexOld\Common\Exception\NotFoundException;
use YandexOld\DataSync\Exception\RevisionOnServerOverCurrentException;
use YandexOld\DataSync\Exception\RevisionTooOldException;
use YandexOld\Common\Exception\TooManyRequestsException;
use YandexOld\Common\Exception\UnauthorizedException;
use YandexOld\Common\Exception\UnavailableResourceException;
use YandexOld\DataSync\Exception\DataSyncException;
use YandexOld\DataSync\Models\Database;
use YandexOld\DataSync\Responses\DatabaseDeltasResponse;
use YandexOld\DataSync\Responses\DatabaseSnapshotResponse;
use YandexOld\DataSync\Responses\DatabasesResponse;
